"""
Django settings for finanzas_diplomado_backend project.
...
ROOT_URLCONF = 'finanzas_diplomado_backend.urls'
...
WSGI_APPLICATION = 'finanzas_diplomado_backend.wsgi.application'
